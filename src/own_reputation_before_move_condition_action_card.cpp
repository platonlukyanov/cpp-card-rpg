...
OwnReputationBeforeMoveConditionActionCard::
    OwnReputationBeforeMoveConditionActionCard(int id, const std::string& name,
...
bool OwnReputationBeforeMoveConditionActionCard::isPossibleToPlay(
