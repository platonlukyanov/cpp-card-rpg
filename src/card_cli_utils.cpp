...
void displayCard(Card* card) {
    ...
    switch (card->getType()) {
        case Card::Type::ACTION: {
            ...
            printStat("Reputation", actionCard->getReputationChange(), Color::RED);
        ...
        case Card::Type::LEVERAGE: {
            ...
            printStat("Reputation", leverageCard->getReputationDamage(), Color::RED);
...
void displayCardShort(std::shared_ptr<Card> card) {
    ...
    if (card->getType() == Card::Type::LEVERAGE) {
        ...
        std::cout << " (Damage: ";
        printColored(std::to_string(leverageCard->getMoneyDamage()), Color::GREEN);
        std::cout << ", ";
        printColored(std::to_string(leverageCard->getReputationDamage()), Color::RED);
        std::cout << ", ";
        printColored(std::to_string(leverageCard->getTrustDamage()), Color::BLUE);
        std::cout << ")";
    }
    std::cout << std::endl;
}
