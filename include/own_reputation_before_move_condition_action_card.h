 ...
 * Lab Work 2
 */
#ifndef INCLUDE_OWN_REPUTATION_BEFORE_MOVE_CONDITION_ACTION_CARD_H
#define INCLUDE_OWN_REPUTATION_BEFORE_MOVE_CONDITION_ACTION_CARD_H
#include "action_card.h"
#include "player.h"

/**
 * @brief Action card that requires a minimum reputation level before a move
 *
 * This class represents a special type of action card that can only be played
 * if the player has a certain minimum reputation level before their move.
...
class OwnReputationBeforeMoveConditionActionCard : public ActionCard {
    public:
         ...
         * card
         */
        OwnReputationBeforeMoveConditionActionCard(int id,
