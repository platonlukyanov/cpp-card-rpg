...
TEST_F(StackTest, FetchPlayersCardsReturnsCorrectCards) {
    ...
    EXPECT_TRUE(cards[0]->getName() == "Developer")
        << "Card 0 name mismatch: expected 'Developer', got '"
        << cards[0]->getName() << "'";
    EXPECT_TRUE(cards[1]->getName() == "Sales Manager")
        << "Card 1 name mismatch: expected 'Sales Manager', got '"
        << cards[1]->getName() << "'";
    EXPECT_TRUE(cards[2]->getName() == "Lawyer")
        << "Card 2 name mismatch: expected 'Lawyer', got '"
        << cards[2]->getName() << "'";
}
